...
| `VITE_API_PORT` | En développement local uniquement : doit être égal à `APP_PORT`. Pour plus de contexte, voir [#48](https://github.com/etalab/catalogage-donnees/pull/48) | |
